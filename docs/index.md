...
<p style="margin-top: 14px; color: var(--vp-c-text-2);">→ Read the curated breakdown: <a href="concepts/loadout-as-budget"><strong>Loadout as budget</strong></a></p>
...
<a class="concept-callout" href="concepts/bounded-roguelite">
  <p class="cc-name">Bounded roguelite</p>
