...
Screenshots are sourced from [Game UI Database](https://www.gameuidatabase.com/gameData.php?id=2192) (Hades II UI gallery, 44 1920×1080 screenshots). One image is from Hades 1's opening cinematic via the same source.
