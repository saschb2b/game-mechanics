---
title: "Hollow Knight: Ludonarrative reading"
type: game
game: hollow-knight
---
...
> A reading of Hollow Knight's mechanics through the [ludonarrative resonance](/concepts/ludonarrative-resonance) lens, does what the player *does* affirm what the game says it's *about*?
>
> **Mechanic read:** [Earned cartography](./map-and-discovery) (Cornifer + benches + Iselda's shop) + silent protagonist + [shade-on-death](./shade-on-death).
>
...
![Hollow Knight world map of Hallownest, the entire interconnected metroidvania, with named regions: Forgotten Crossroads, City of Tears, Fungal Wastes, Royal Waterways, Deepnest, Crystal Peak, and more](/images/hollow-knight/hk-world-map.jpg)
*The map is *only* this clean because the player has visited each region, found Cornifer there, drawn it up, and bought every upgrade from Iselda. A new player's map is mostly empty for the first 20 hours. Source: [Game UI Database](https://www.gameuidatabase.com/gameData.php?id=113).*
...
- Mechanic pages: [Map & discovery](./map-and-discovery), [Shade on death](./shade-on-death)
- Lens (overview): [Ludonarrative resonance](/concepts/ludonarrative-resonance)
- Adjacent pattern: [`bonus-with-drawback`](/concepts/bonus-with-drawback): the Compass-charm-cost / Wayward-Compass-vs-real-charm tradeoff.
