---
title: "Breath of the Wild: Patterns"
type: game
game: zelda-botw
---
...
| [`bonus-with-drawback`](/concepts/bonus-with-drawback) | Multiple structural cases: weapon durability (every weapon is a depleting resource); Heart vs Stamina at every Goddess Statue (irreversible per-decision tradeoff); metal weapons in storms (strong but lightning-magnet). |
| [`late-introduced-mechanics`](/concepts/late-introduced-mechanics) | Most *combinations* of the verb-set aren't taught: discovered by experiment across 30+ hours. The Master Sword unlocks at 13 hearts, the DLC at full main-game completion, the Hyrule Compendium across the whole game. |
