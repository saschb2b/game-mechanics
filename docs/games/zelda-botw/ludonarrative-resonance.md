---
title: "Breath of the Wild: Ludonarrative reading"
type: game
game: zelda-botw
patterns:
...
Reading Breath of the Wild's mechanics through the [resonance lens](/concepts/ludonarrative-resonance).
...
In the [main resonance table](/concepts/ludonarrative-resonance), BOTW sits in the **affirms** cluster, alongside Hades, Hollow Knight, MMBN, Moonlighter 2, Xenoblade. Compared to those:
