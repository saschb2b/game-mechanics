...
iconic_mechanic: "Multiplicative chemistry engine + climb-anywhere stamina + 120-shrine puzzle network"
core_dialectic: "Reach for any visible point: and pay for it in stamina, weather, or weapons"
patterns:
  - chemistry-engine
...
tags: [open-world, action-adventure, single-player, switch, wii-u]
og_image: images/zelda-botw/title-screen.jpg
---
...
![The Legend of Zelda: Breath of the Wild title screen, Link in his blue Champion's Tunic standing on a rocky outcrop, looking out over Hyrule with the destroyed Hyrule Castle in the distance and the sunset breaking through clouds. Menu: Continue / New Game / Play in Master Mode / Options / amiibo / DLC Purchased](/images/zelda-botw/title-screen.jpg)
*Breath of the Wild's title screen: the iconic "looking out at the world" framing is also the game's design pitch: pick any visible point, walk there. The hero is positioned the same way the player will be on the Great Plateau ledge ~30 minutes into the game. Source: [Game UI Database](https://www.gameuidatabase.com/gameData.php?id=35).*
...
weather and time:
  ...
  weather drives climb / fire / electricity / cold rules; you check sky before commitment
```

## Mechanic deep-dives

- [**The chemistry engine**](./chemistry-engine): fire, ice, wind, water, electricity as systemic rules. Burn grass to make updrafts; freeze water to make pillars; metal weapons attract lightning. The "multiplicative" core.
- [**Climbing + the stamina ring**](./climbing-stamina): almost every surface is climbable; vertical movement is gated by a stamina meter that recharges and is upgraded by Stamina Vessels. The ring is the entire traversal economy.
- [**Weapon degradation**](./weapon-degradation): every melee weapon, bow, and shield breaks. Aonuma's defense, the divisive reception, and what the system actually does for combat pacing.
- [**The shrine network**](./shrine-network): 120 small puzzles (~10 min each) replacing classic Zelda's 8 long dungeons. Why Fujibayashi made the trade, and how it changes the game's exploration shape.
- [**Sheikah Slate runes + traversal devices**](./runes-and-traversal): Magnesis, Stasis, Cryonis, Bombs, Camera, plus the paraglider, horse, and (DLC) Master Cycle. The fixed verb-set you carry into every shrine.

## Through other lenses

- [**Ludonarrative reading**](./ludonarrative-resonance): these mechanics read through the [resonance lens](/concepts/ludonarrative-resonance). **Verdict: affirms**, Hyrule's "long quiet after the calamity" reads in the texture of every system: weapons break, the world hasn't been cared for in 100 years, the shrines are quiet, the climb is slow.
...
- [Design tensions](./design-tensions): Fujibayashi / Aonuma quotes on multiplicative design, weapon durability, and shrines-vs-dungeons
