---
title: "Mega Man Battle Network: Ludonarrative reading"
type: game
...
> A reading of MMBN's mechanics through the [ludonarrative resonance](/concepts/ludonarrative-resonance) lens, does what the player *does* affirm what the game says it's *about*?
>
> **Mechanic read:** [Folder & chip codes](./folder-and-chip-codes), [NaviCust](./navicust), [Program Advance](./program-advance), and the [battle system](./battle-system).
>
...
![6×3 grid combat with the Custom Gauge across the top, MegaMan firing his buster, an enemy queued on the right](/images/mega-man-battle-network/combat-grid-custom-gauge.jpg)
*The single iconic frame of the entire series. The Custom Gauge filling in real time IS the fiction's "PET buffering your next dispatch of compatible code." Source: [Steam (Legacy Collection)](https://store.steampowered.com/app/1798010/).*
...
- Mechanic pages: [Folder & chip codes](./folder-and-chip-codes), [NaviCust](./navicust), [Program Advance](./program-advance), [Battle system](./battle-system)
- Lens (overview): [Ludonarrative resonance](/concepts/ludonarrative-resonance)
- Adjacent pattern: [`code-constrained-deckbuilding`](/concepts/loadout-as-budget): code-compatibility as a loadout constraint *because* the fiction says runtime compatibility matters.
