...
Panels are *resources*. Stealing them compresses the opponent's dodge options. Cracking panels under a flying enemy sets up a free-damage moment when they land.
...
- `draw-step-as-tactical-resource`: the Custom Gauge is the original mechanic here. Card draw becomes something you fight to enable.
