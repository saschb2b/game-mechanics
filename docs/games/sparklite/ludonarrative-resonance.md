---
title: "Sparklite: Ludonarrative reading"
type: game
game: sparklite
---
...
> A reading of Sparklite's mechanics through the [ludonarrative resonance](/concepts/ludonarrative-resonance) lens, does what the player *does* affirm what the game says it's *about*?
>
> **Mechanic read:** the [patch board](./patch-board), the [permalife loop](./world-and-loop), and the Refuge hub.
>
...
*The Refuge: a persistent flying-island home base that grows across deaths. The fiction is "you crashed here, the sky-pirates rebuilt you, you owe them": the hub-upgrade loop is the literal payback. Source: [Steam](https://store.steampowered.com/app/943140/).*
...
- Mechanic pages: [Patch board](./patch-board), [World & loop](./world-and-loop), [Combat](./combat)
- Lens (overview): [Ludonarrative resonance](/concepts/ludonarrative-resonance)
- Adjacent pattern: [`grid-inventory`](/concepts/grid-inventory): the patch-board is one of its variants; the lens explains why a *spatial* loadout reads more diegetic than a numeric stat tree would for this fiction.
