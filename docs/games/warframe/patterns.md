...
| [`random-perfect-roll-economy`](/concepts/random-perfect-roll-economy) | Rivens are unique-stat mods with random rolls → built-in lottery + market mechanic. |
...
| [`nested-progression-graph`](/concepts/nested-progression-graph) | Multiple orthogonal progression axes layered over years. New systems live alongside old ones. |
