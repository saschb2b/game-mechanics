...
| [`crafting-timer-as-pacing`](/patterns/crafting-timer-as-pacing) | Real-time wait (12h/72h) detaches "earned" from "playable", smooths reward dopamine, doubles as soft monetization. |
| [`vault-rotation-economy`](/patterns/vault-rotation-economy) | Older Primes get vaulted, creating scarcity that drives both farming and Prime Access purchases. |
| [`dual-currency-with-trade`](/patterns/dual-currency-with-trade) | Players trade premium currency to each other. Free players become supply for paying players' demand. |
| [`non-streak-login-rewards`](/patterns/non-streak-login-rewards) | Total-days milestones, not consecutive streaks. Friendlier retention. |
