---
title: "Path of Exile 2: Skill gem rework"
type: game
...
This page doesn't introduce new cross-game patterns, the changes are PoE-specific design refinements. The broader pattern is that PoE2 *removes friction that PoE1 had drifted into accepting.* See [design-tensions](./design-tensions.md) for the full pattern of "what GGG walked back in the sequel."
