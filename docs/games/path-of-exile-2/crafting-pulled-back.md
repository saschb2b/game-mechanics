---
title: "Path of Exile 2 — Crafting pulled back"
type: game
...
PoE2 inherits PoE1's [currency-as-crafting](/games/path-of-exile/crafting-and-currency.md) framework — there's no gold, every currency is a crafting reagent — but **simplifies aggressively.**
...
- **Sockets-and-links are gone.** Skill gems carry their own sockets ([see skill-gem-rework](./skill-gem-rework.md)), so the Jeweller's Orbs / Chromatic Orbs / Orb of Fusing complex doesn't exist.
...
- [`currency-as-crafting`](/concepts/currency-as-crafting) — same pattern as PoE1, simplified.
- [`aspirational-crafting`](/concepts/aspirational-crafting) — same philosophy, sequel-tightened.
