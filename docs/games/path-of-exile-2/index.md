...
genre: action-rpg
business_model: f2p
iconic_mechanic: "Slowed combat + weapon-grants-skills"
core_dialectic: "Re-litigating PoE1's drift toward speed-clearing"
patterns:
...
| **Sibling project** | [**Path of Exile 1**](/games/path-of-exile/) — still active, still gets leagues, treated by GGG as a parallel game not a predecessor |
...
- [**Combat philosophy**](./combat-philosophy.md) — the slowdown, dodge roll, weapon-swap, the soulslike turn.
- [**Weapons grant skills**](./weapons-grant-skills.md) — the major break with PoE1.
- [**Skill gem rework**](./skill-gem-rework.md) — uncut gems, unique-per-character supports, no 6-link.
...
- [Sources](./sources.md)
- Sibling: [**Path of Exile 1**](/games/path-of-exile/)
