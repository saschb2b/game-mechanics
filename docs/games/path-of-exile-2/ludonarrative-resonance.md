---
title: "Path of Exile 2: Ludonarrative reading"
type: game
...
> A reading of PoE2's mechanics through the [ludonarrative resonance](/concepts/ludonarrative-resonance) lens, does what the player *does* affirm what the game says it's *about*?
>
> **Mechanic read:** [combat philosophy](./combat-philosophy) (slowed, soulslike-leaning) + [weapons grant skills](./weapons-grant-skills) + [one-death maps](./atlas-one-death) + the inherited optimisation loop (currency-as-crafting, passive tree, atlas).
>
...
![PoE2 Act 2 boss Jamanra, the Risen King, desert arena with a multi-phase boss](/images/path-of-exile-2/boss-jamanra.jpg)
*The Jamanra fight is the canonical "PoE2 demands you respect the encounter" moment for early-access players: slowed combat, telegraphed attacks, real consequence for sloppy positioning. Source: [Steam](https://store.steampowered.com/app/2694490/).*
...
- Mechanic pages: [Combat philosophy](./combat-philosophy), [Weapons grant skills](./weapons-grant-skills), [Atlas (one-death)](./atlas-one-death), [Crafting pulled back](./crafting-pulled-back)
- Sibling reading: [Path of Exile 1: Ludonarrative reading](/games/path-of-exile/ludonarrative-resonance) (clean orthogonal)
- Lens (overview): [Ludonarrative resonance](/concepts/ludonarrative-resonance)
- Adjacent pattern: [`vision-driven-iteration`](/concepts/vision-driven-iteration): GGG's decision to fix the combat-feel rather than the meta-loop is itself a vision call.
