...
The Abandoned Deck (no face cards) has the highest skill ceiling: Royal Flush is impossible, Full House is harder, but Pair-and-Three-of-a-Kind builds become extremely consistent.
...
A player who's cleared every deck on White Stake (15 cells) has played the game 15 times. A Gold Stake completionist has played 120 *targeted* runs, many more than 120 counting failures.
