...
> Wiki: *"usually a normal gauntlet has 11 rooms"* [^wiki-crusade]. **The room count is fixed per gauntlet**, not variable. This is the strongest single tell that the inside-a-node layout is template-driven, not free-procedural.
