...
![Top-down 3D combat with sword strike, multiple enemies, perk slots visible top-left](/images/moonlighter-2/combat-melee.jpg)
*Top-down 3D combat in Zephyr Fields. Note the **three perk slots** in the upper-left HUD (greyed/teal squares); these track perks chosen along the dungeon map (Hades-style). Source: [Steam](https://store.steampowered.com/app/2350790/Moonlighter_2_The_Endless_Vault/).*
...
![Boss arena with projectile rain](/images/moonlighter-2/boss-fight.jpg)
*A boss encounter: bullet-hell projectile patterns in 3D. Source: [Steam](https://store.steampowered.com/app/2350790/Moonlighter_2_The_Endless_Vault/).*
...
- **3D action combat is harder than it looks for a sequel.** Reviewers consistently note the 2D→3D shift loses *some* charm even as it gains depth. If you sequel a beloved 2D game in 3D, expect this trade-off and design for it.
