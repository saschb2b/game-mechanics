---
title: "Moonlighter 2: Ludonarrative reading"
type: game
game: moonlighter-2
---
...
> A reading of Moonlighter 2's mechanics through the [ludonarrative resonance](/concepts/ludonarrative-resonance) lens, does what the player *does* affirm what the game says it's *about*?
>
> **Mechanic read:** the [dual-life loop](./dual-life-loop), the [backpack puzzle](./backpack-puzzle), and [shop pricing](./shop-pricing).
>
...
![Backpack puzzle with relic synergies, Soldier Doll selected, showing POINTED + ABSORB markers](/images/moonlighter-2/backpack-puzzle.jpg)
*The backpack: you don't have a flat inventory and a separate shop. You have a packing puzzle whose adjacency rules determine what survives the trip back. The puzzle is the shopkeeper's act. Source: [Steam](https://store.steampowered.com/app/2350790/).*
...
- Mechanic pages: [Dual-life loop](./dual-life-loop), [Backpack puzzle](./backpack-puzzle), [Shop & pricing](./shop-pricing)
- Lens (overview): [Ludonarrative resonance](/concepts/ludonarrative-resonance)
- Adjacent pattern: [`loadout-as-budget`](/concepts/loadout-as-budget): the backpack puzzle is one of its variants; the lens explains why the *spatial* version of the budget feels diegetic in a way a pure numeric budget wouldn't.
