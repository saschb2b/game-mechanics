---
title: "Path of Exile: Ludonarrative reading"
type: game
game: path-of-exile
---
...
> A reading of Path of Exile's loop through the [ludonarrative resonance](/concepts/ludonarrative-resonance) lens, does what the player *does* affirm what the game says it's *about*?
>
> **Mechanic read:** the loot / skill-gem / [passive tree](./passive-tree) / [Atlas of Worlds](./atlas) loop.
>
...
![Path of Exile Atlas of Worlds, massive node graph of map endgame, hundreds of interconnected map nodes](/images/path-of-exile/atlas-of-worlds.jpg)
*The Atlas: a meta-progression surface of ~700 map nodes layered on top of the ~1500-node character passive tree. Beautiful. Almost entirely silent on Wraeclast. Source: [Steam](https://store.steampowered.com/app/238960/).*
...
1. **Story acts are skippable.** Players have been able to ignore plot beats since the first ten acts shipped. GGG knows the loop is the product; story is service.
2. **Lore is opt-in cipher.** Forsaken Masters dialogue, hidden lore tablets, cryptic environmental detail. Players who want the lore can dig for it; players who don't never have to.
3. **The optimisation surface is the marketing.** League launches are pitched on what *math* is new. New skill gems, new map mods, new currency. Trailers show numbers go bigger. Compare to a game that ships a thirty-minute opening cutscene about themes its loop will never touch.
...
- Mechanic pages: [Passive tree](./passive-tree), [Atlas of Worlds](./atlas), [Trade & economy](./trade-and-economy)
- Lens (overview): [Ludonarrative resonance](/concepts/ludonarrative-resonance)
- Adjacent pattern: [`vision-driven-iteration`](/concepts/vision-driven-iteration): GGG's design philosophy is explicit that the loop is the product.
