...
- [`nested-progression-graph`](/concepts/nested-progression-graph) — the passive tree is one axis; ascendancy, the Atlas tree, gear, and skill gems are orthogonal axes. PoE's progression is a graph, not a line.
