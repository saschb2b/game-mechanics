...
- **Gating prose behind upgrade levels couples narrative to engagement.** The player who *uses* the weapon gets the story; the player who hoards it doesn't. This is a form of `late-introduced-mechanics` operating at the prose layer.
- **The discoverable surface should reward seekers without punishing skippers.** A player who never opens the Story menu still finishes the game. A player who reads every weapon's story has read a 100-page short-story collection. Same game; different texture.
