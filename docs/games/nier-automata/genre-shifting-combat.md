...
![SKILLS root menu with two top-level skill categories: "Pod Programs" (18% complete) and "Plug-in Chips". Right panel: 9S Lv 33 with full status](/images/nier-automata/skills-root-pod-chips.jpg)
