...
- **Fully procedural.** Every layout is unique, but the moments inside (puzzles, set-pieces, encounter beats) are weak: the procedural layer can't author elegant Zelda-style progressions or detailed trap rooms. Devs of PCG dungeon games have repeatedly hit this wall.
