...
- [`random-perfect-roll-economy`](/concepts/random-perfect-roll-economy): the *natural endpoint* of aspirational crafting, where per-item uniqueness becomes a market commodity. PoE's mirror-tier items + Warframe's god-roll Rivens are the same shape.
