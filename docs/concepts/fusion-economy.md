...
> **Lemma:** Multiple low-tier items consolidate into one higher-tier item. The result is **fewer pieces, more concentrated value**; it solves the "loot drowns the inventory" problem without destroying loot.
