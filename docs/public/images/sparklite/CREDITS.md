...
| File | Source | Showing |
|---|---|---|
| `adventure-log-ui.jpg` | [Steam](https://store.steampowered.com/app/943140/Sparklite/) | Adventure Log UI: Sparklite currency, patches list, Furnace progress |
| `combat-wrench.jpg` | [Steam](https://store.steampowered.com/app/943140/Sparklite/) | Top-down combat with the wrench attack arc |
...
- A clear shot of the **patch board UI** (Med Bay 3×3/4×4/5×5 grid with Tetris-shaped patches placed). Steam screenshots don't include this; Fandom wiki may.
- A boss / Titan fight screenshot.
- The **fracture animation** when the world reshuffles on death.
